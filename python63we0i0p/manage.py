...
def replace_admin():
    ...
    if os.path.isfile(filePath):
        ...
        with open(filePath,"r",encoding="utf-8") as f:
            datas=f.read()
        datas=datas.replace('baseurl+"admin/dist/index.html#"','"http://localhost:5001/admin"')
        datas=datas.replace('baseurl+"admin/dist/index.html#/login"','"http://localhost:5001/admin"')
