...
# 注册接口
@main_bp.route("/python63we0i0p/news/register", methods=['POST'])
def python63we0i0p_news_register():
...
# 登录接口
@main_bp.route("/python63we0i0p/news/login", methods=['GET','POST'])
def python63we0i0p_news_login():
...
# 登出接口
@main_bp.route("/python63we0i0p/news/logout", methods=['POST'])
def python63we0i0p_news_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python63we0i0p/news/resetPass", methods=['POST'])
def python63we0i0p_news_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python63we0i0p/news/session", methods=['GET'])
def python63we0i0p_news_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python63we0i0p/news/page", methods=['GET'])
def python63we0i0p_news_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python63we0i0p/news/autoSort", methods=['GET'])
def python63we0i0p_news_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python63we0i0p/news/list", methods=['GET'])
def python63we0i0p_news_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python63we0i0p/news/save", methods=['POST'])
def python63we0i0p_news_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python63we0i0p/news/add", methods=['POST'])
def python63we0i0p_news_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python63we0i0p/news/thumbsup/<id_>", methods=['GET'])
def python63we0i0p_news_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python63we0i0p/news/info/<id_>", methods=['GET'])
def python63we0i0p_news_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python63we0i0p/news/detail/<id_>", methods=['GET'])
def python63we0i0p_news_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python63we0i0p/news/update", methods=['POST'])
def python63we0i0p_news_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python63we0i0p/news/delete", methods=['POST'])
def python63we0i0p_news_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python63we0i0p/news/vote/<int:id_>", methods=['POST'])
def python63we0i0p_news_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python63we0i0p/news/group/<columnName>", methods=['GET'])
def python63we0i0p_news_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python63we0i0p/news/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python63we0i0p_news_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python63we0i0p/news/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python63we0i0p_news_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python63we0i0p/news/valueMul/<xColumnName>", methods=['GET'])
def python63we0i0p_news_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python63we0i0p/news/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python63we0i0p_news_valueMul_time(xColumnName):
...
# 推荐算法接口
@main_bp.route("/python63we0i0p/news/autoSort2", methods=['GET'])
def python63we0i0p_news_autoSort2():
    if request.method == 'GET':
...
# 统计接口
@main_bp.route("/python63we0i0p/news/remind/<columnName>/<type>", methods=['GET'])  #
def python63we0i0p_news_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python63we0i0p/news/lists", methods=['GET'])
def python63we0i0p_news_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
