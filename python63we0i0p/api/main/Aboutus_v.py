...
# 注册接口
@main_bp.route("/python63we0i0p/aboutus/register", methods=['POST'])
def python63we0i0p_aboutus_register():
...
# 登录接口
@main_bp.route("/python63we0i0p/aboutus/login", methods=['GET','POST'])
def python63we0i0p_aboutus_login():
...
# 登出接口
@main_bp.route("/python63we0i0p/aboutus/logout", methods=['POST'])
def python63we0i0p_aboutus_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python63we0i0p/aboutus/resetPass", methods=['POST'])
def python63we0i0p_aboutus_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python63we0i0p/aboutus/session", methods=['GET'])
def python63we0i0p_aboutus_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python63we0i0p/aboutus/page", methods=['GET'])
def python63we0i0p_aboutus_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python63we0i0p/aboutus/autoSort", methods=['GET'])
def python63we0i0p_aboutus_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python63we0i0p/aboutus/list", methods=['GET'])
def python63we0i0p_aboutus_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python63we0i0p/aboutus/save", methods=['POST'])
def python63we0i0p_aboutus_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 添加接口（前端）
@main_bp.route("/python63we0i0p/aboutus/add", methods=['POST'])
def python63we0i0p_aboutus_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python63we0i0p/aboutus/thumbsup/<id_>", methods=['GET'])
def python63we0i0p_aboutus_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python63we0i0p/aboutus/info/<id_>", methods=['GET'])
def python63we0i0p_aboutus_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python63we0i0p/aboutus/detail/<id_>", methods=['GET'])
def python63we0i0p_aboutus_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python63we0i0p/aboutus/update", methods=['POST'])
def python63we0i0p_aboutus_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 删除接口
@main_bp.route("/python63we0i0p/aboutus/delete", methods=['POST'])
def python63we0i0p_aboutus_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python63we0i0p/aboutus/vote/<int:id_>", methods=['POST'])
def python63we0i0p_aboutus_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python63we0i0p/aboutus/group/<columnName>", methods=['GET'])
def python63we0i0p_aboutus_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
        ...
        json_filename='aboutus'+f'_group_{columnName}.json'

        where = ' where 1 = 1 '
        sql = "SELECT COUNT(*) AS total, " + columnName + " FROM aboutus " + where + " GROUP BY " + columnName
...
# 按值统计接口
@main_bp.route("/python63we0i0p/aboutus/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python63we0i0p_aboutus_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python63we0i0p/aboutus/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python63we0i0p_aboutus_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
        ...
        msg['data'] = results
        json_filename='aboutus'+f'_value_{xColumnName}_{yColumnName}.json'
        with open(json_filename, 'w', encoding='utf-8') as f:
...
# 按值统计（多）
@main_bp.route("/python63we0i0p/aboutus/valueMul/<xColumnName>", methods=['GET'])
def python63we0i0p_aboutus_valueMul(xColumnName):
    ...
    if request.method == 'GET':
        ...
        for item in req_dict['yColumnNameMul'].split(','):
            sql = "SELECT {0}, sum({1}) AS total FROM aboutus {2} GROUP BY {0} LIMIT 10".format(xColumnName, item, where)
            L = []
            data = db.session.execute(sql)
            data = data.fetchall() 
            for i in range(len(data)):
...
# 按值统计（多）
@main_bp.route("/python63we0i0p/aboutus/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python63we0i0p_aboutus_valueMul_time(xColumnName):
    ...
    if request.method == 'GET':
        ...
        for item in req_dict['yColumnNameMul'].split(','):
            sql = ''
            if timeStatType == '日':
                sql = "SELECT DATE_FORMAT({0}, '%Y-%m-%d') {0}, sum({1}) total FROM aboutus {2} GROUP BY DATE_FORMAT({0}, '%Y-%m-%d') LIMIT 10".format(xColumnName, item, where, '%Y-%m-%d')

            if timeStatType == '月':
                sql = "SELECT DATE_FORMAT({0}, '%Y-%m') {0}, sum({1}) total FROM aboutus {2} GROUP BY DATE_FORMAT({0}, '%Y-%m') LIMIT 10".format(xColumnName, item, where, '%Y-%m')

            if timeStatType == '年':
                sql = "SELECT DATE_FORMAT({0}, '%Y') {0}, sum({1}) total FROM aboutus {2} GROUP BY DATE_FORMAT({0}, '%Y') LIMIT 10".format(xColumnName, item, where, '%Y')
            L = []
            data = db.session.execute(sql)
            data = data.fetchall() 
            for i in range(len(data)):
...
# 统计接口
@main_bp.route("/python63we0i0p/aboutus/remind/<columnName>/<type>", methods=['GET'])  #
def python63we0i0p_aboutus_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python63we0i0p/aboutus/lists", methods=['GET'])
def python63we0i0p_aboutus_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
        list,_,_,_,_ = aboutus.page(aboutus,aboutus,{})
        msg['data'] = list
        return jsonify(msg)
