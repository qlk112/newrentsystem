...
# 注册接口
@main_bp.route("/python63we0i0p/yonghu/register", methods=['POST'])
def python63we0i0p_yonghu_register():
...
# 登录接口
@main_bp.route("/python63we0i0p/yonghu/login", methods=['GET','POST'])
def python63we0i0p_yonghu_login():
...
# 登出接口
@main_bp.route("/python63we0i0p/yonghu/logout", methods=['POST'])
def python63we0i0p_yonghu_logout():
    if request.method == 'POST':
        msg = {
            "msg": "退出成功",
            "code": 0
...
# 重置密码接口
@main_bp.route("/python63we0i0p/yonghu/resetPass", methods=['POST'])
def python63we0i0p_yonghu_resetpass():
    '''
    '''
    if request.method == 'POST':
...
# 获取会话信息接口
@main_bp.route("/python63we0i0p/yonghu/session", methods=['GET'])
def python63we0i0p_yonghu_session():
    '''
    '''
...
# 分类接口（后端）
@main_bp.route("/python63we0i0p/yonghu/page", methods=['GET'])
def python63we0i0p_yonghu_page():
    '''
    '''
    if request.method == 'GET':
...
# 排序接口
@main_bp.route("/python63we0i0p/yonghu/autoSort", methods=['GET'])
def python63we0i0p_yonghu_autosort():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 分页接口（前端）
@main_bp.route("/python63we0i0p/yonghu/list", methods=['GET'])
def python63we0i0p_yonghu_list():
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success",  "data":{"currPage":1,"totalPage":1,"total":1,"pageSize":10,"list":[]}}
...
# 保存接口（后端）
@main_bp.route("/python63we0i0p/yonghu/save", methods=['POST'])
def python63we0i0p_yonghu_save():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        if yonghu.count(yonghu, yonghu, {"yonghuzhanghao":req_dict["yonghuzhanghao"]})>0:
            msg['code'] = crud_error_code
            msg['msg'] = "用户账号已存在"
            return jsonify(msg)
        for key in req_dict:
...
# 添加接口（前端）
@main_bp.route("/python63we0i0p/yonghu/add", methods=['POST'])
def python63we0i0p_yonghu_add():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 踩、赞接口
@main_bp.route("/python63we0i0p/yonghu/thumbsup/<id_>", methods=['GET'])
def python63we0i0p_yonghu_thumbsup(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（后端）
@main_bp.route("/python63we0i0p/yonghu/info/<id_>", methods=['GET'])
def python63we0i0p_yonghu_info(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 获取详情信息（前端）
@main_bp.route("/python63we0i0p/yonghu/detail/<id_>", methods=['GET'])
def python63we0i0p_yonghu_detail(id_):
    '''
    '''
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 更新接口
@main_bp.route("/python63we0i0p/yonghu/update", methods=['POST'])
def python63we0i0p_yonghu_update():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
        req_dict = session.get("req_dict")
        if db.session.query(func.count(getattr(yonghu, 'id'))).filter(yonghu.id !=req_dict["id"], yonghu.yonghuzhanghao == req_dict["yonghuzhanghao"]).scalar()>0:
            msg['code'] = crud_error_code
            msg['msg'] = "用户账号已存在"
            return jsonify(msg)
...
# 删除接口
@main_bp.route("/python63we0i0p/yonghu/delete", methods=['POST'])
def python63we0i0p_yonghu_delete():
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success", "data": {}}
...
# 投票接口
@main_bp.route("/python63we0i0p/yonghu/vote/<int:id_>", methods=['POST'])
def python63we0i0p_yonghu_vote(id_):
    '''
    '''
    if request.method == 'POST':
        msg = {"code": normal_code, "msg": "success"}
...
# 分组统计接口
@main_bp.route("/python63we0i0p/yonghu/group/<columnName>", methods=['GET'])
def python63we0i0p_yonghu_group(columnName):
    '''
    分组统计接口
    '''
    if request.method == 'GET':
...
# 按值统计接口
@main_bp.route("/python63we0i0p/yonghu/value/<xColumnName>/<yColumnName>", methods=['GET'])
def python63we0i0p_yonghu_value(xColumnName, yColumnName):
    '''
    按值统计接口,
    {
        "code": 0,
...
# 按日期统计接口
@main_bp.route("/python63we0i0p/yonghu/value/<xColumnName>/<yColumnName>/<timeStatType>", methods=['GET'])
def python63we0i0p_yonghu_value_riqi(xColumnName, yColumnName, timeStatType):
    '''
    按日期统计接口
    '''
    if request.method == 'GET':
...
# 按值统计（多）
@main_bp.route("/python63we0i0p/yonghu/valueMul/<xColumnName>", methods=['GET'])
def python63we0i0p_yonghu_valueMul(xColumnName):
...
# 按值统计（多）
@main_bp.route("/python63we0i0p/yonghu/valueMul/<xColumnName>/<timeStatType>", methods=['GET'])
def python63we0i0p_yonghu_valueMul_time(xColumnName):
...
# 统计接口
@main_bp.route("/python63we0i0p/yonghu/remind/<columnName>/<type>", methods=['GET'])  #
def python63we0i0p_yonghu_remind(columnName,type):
    '''
    '''
    if request.method == 'GET':
...
#分类列表
@main_bp.route("/python63we0i0p/yonghu/lists", methods=['GET'])
def python63we0i0p_yonghu_lists():
    if request.method == 'GET':
        msg = {"code": normal_code, "msg": "success", "data": []}
