...
def before_request():
    ...
    if request.method == 'GET':
        get_list = [
            "/",
            "/apidocs/",
             "/python63we0i0p/examusers/login" ,
            "/python63we0i0p/examusers/register",
            '/python63we0i0p/defaultuser/login',
            '/python63we0i0p/users/login',
        ...
        post_list = [
            '/python63we0i0p/defaultuser/register',
            '/python63we0i0p/defaultuser/login',
            '/python63we0i0p/users/register',
            '/python63we0i0p/users/login',
            "/python63we0i0p/examusers/login" ,
            "/python63we0i0p/examusers/register"
        ]  # 免认证list
