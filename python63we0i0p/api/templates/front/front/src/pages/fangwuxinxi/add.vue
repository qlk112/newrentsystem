...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    <el-form
      ...
      label-width="180px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="房屋名称" prop="fangwumingcheng">
            <el-input v-model="ruleForm.fangwumingcheng" 
                placeholder="房屋名称" clearable :disabled=" false  ||ro.fangwumingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="房屋楼层" prop="fangwulouceng">
            <el-input v-model.number="ruleForm.fangwulouceng" 
                placeholder="房屋楼层" clearable :disabled=" false  ||ro.fangwulouceng"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="房屋图片" v-if="type!='cross' || (type=='cross' && !ro.fangwutupian)" prop="fangwutupian">
            <file-upload
            tip="点击上传房屋图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' class="upload" v-else label="房屋图片" prop="fangwutupian">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="房屋面积" prop="fangwumianji">
            <el-input v-model="ruleForm.fangwumianji" 
                placeholder="房屋面积" clearable :disabled=" false  ||ro.fangwumianji"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="租赁价格" prop="zulinjiage">
			<el-input-number v-model="ruleForm.zulinjiage" placeholder="租赁价格" :disabled="ro.zulinjiage"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="房屋地址" prop="fangwudizhi">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="周边信息" prop="zhoubianxinxi">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="周边信息"
              v-model="ruleForm.zhoubianxinxi">
            </el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="房屋设施" prop="fangwusheshi">
            <editor 
                ...
                v-model="ruleForm.fangwusheshi" 
                class="editor" 
                action="file/upload">
            </editor>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="房屋详情" prop="fangwuxiangqing">
            <editor 
                :style='{"minHeight":"250px","padding":"0","margin":"0","borderColor":"#1abc9e30","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0px","width":"100%","borderStyle":"solid","height":"auto"}'
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='fangwulouceng'){
              this.ruleForm.fangwulouceng = obj[o];
              this.ro.fangwulouceng = true;
              continue;
            }
            if(o=='fangwutupian'){
            ...
            if(o=='zhoubianxinxi'){
              this.ruleForm.zhoubianxinxi = obj[o];
              this.ro.zhoubianxinxi = true;
              continue;
            }
            if(o=='fangwusheshi'){
