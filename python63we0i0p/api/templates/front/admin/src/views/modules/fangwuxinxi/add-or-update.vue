	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="房屋楼层" prop="fangwulouceng">
					<el-input v-model.number="ruleForm.fangwulouceng" placeholder="房屋楼层" clearable  :readonly="ro.fangwulouceng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="房屋楼层" prop="fangwulouceng">
					<el-input v-model="ruleForm.fangwulouceng" placeholder="房屋楼层" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.fangwutupian" label="房屋图片" prop="fangwutupian">
					<file-upload
						tip="点击上传房屋图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.fangwutupian" label="房屋图片" prop="fangwutupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="租赁价格" prop="zulinjiage">
					<el-input-number v-model="ruleForm.zulinjiage" placeholder="租赁价格" :readonly="ro.zulinjiage"></el-input-number>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="周边信息" prop="zhoubianxinxi">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhoubianxinxi" label="周边信息" prop="zhoubianxinxi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhoubianxinxi}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="房屋设施" prop="fangwusheshi">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.fangwusheshi" label="房屋设施" prop="fangwusheshi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.fangwusheshi"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.fangwusheshi = this.ruleForm.fangwusheshi.replace(reg,'../../../python63we0i0p/upload');
        this.ruleForm.fangwuxiangqing = this.ruleForm.fangwuxiangqing.replace(reg,'../../../python63we0i0p/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
