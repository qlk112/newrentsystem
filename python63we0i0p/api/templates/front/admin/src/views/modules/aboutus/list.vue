		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- 无 -->
					<el-table-column :resizable='false' :sortable='true' prop="picture1" width="200" label="图片1">
						<template slot-scope="scope">
					...
					<!-- 无 -->
					<el-table-column :resizable='false' :sortable='true' prop="picture2" width="200" label="图片2">
						<template slot-scope="scope">
					...
					<!-- 无 -->
					<el-table-column :resizable='false' :sortable='true' prop="picture3" width="200" label="图片3">
						<template slot-scope="scope">
