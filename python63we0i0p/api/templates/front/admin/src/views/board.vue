<template>
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231223/2592f2b1d33d45d299f892501055ed24.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		<div id="particles"></div>
		<div :style='{"width":"100%","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20231223/3329204d7f474f8598c2b6cf87835385.gif) no-repeat center top / 100% 100%","height":"80px"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0 0 0 0","color":"#fff","textAlign":"center","width":"100%","lineHeight":"80px","fontSize":"22px","height":"80px"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"54px","fontSize":"14px","position":"absolute","right":"60px","height":"64px"}'>{{ dates }}</div>
		</div>
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
						<div :style='{"color":"#fff","fontSize":"16px"}'>
							价格统计
						</div>
					</div>
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="zufangChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="zufangChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"40%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"0","margin":"0 0 20px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"calc(32% - 20px)"}'>
					...
					<div :style='{"margin":"0 0 0 20px","overflow":"hidden","color":"#fff","flex":1,"lineHeight":"24px","fontSize":"14px","height":"100%"}' v-html="systemIntroductionDetail.content"></div>
				</div>
				<!-- 统计 -->
				<div :style='{"alignContent":"center","padding":"0","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"100px","order":"1"}'>

					<div :style='{"margin":"0 10px 0 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231223/9c1f0d184ede4dee8925bb6c57ba14b7.png) no-repeat center top / 100% 100%","flexDirection":"column","flex":"1","display":"flex","width":"calc(20% - 10px)","justifyContent":"center","height":"100%"}'>
						...
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column-reverse","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>租房数据总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{zufangCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","width":"100%","fontSize":"16px","height":"42px"}'>租房数据</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(92,135,230,.3)","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="postdate" label="更新时间"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="price" label="价格（元/月）"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="areanum" label="面积（平米）"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="floor" label="楼层"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="geju" label="格局"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="address" label="地址"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="zufangChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","margin":"0 0 0px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="zufangChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","textAlign":"left","background":"url(http://codegen.caihongy.cn/20231223/a17650c7939541fdbd37f9b82a08d2b3.png) no-repeat center bottom / 100% auto","height":"42px"}'>
						<div :style='{"color":"#fff","fontSize":"16px"}'>
							格局统计
						</div>
					</div>
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="zufangChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
	data() {
		return {
			...
			map: {"tooltip":{"formatter":"{b} : {c}","trigger":"item"},"backgroundColor":"transparent","title":{"borderType":"solid","padding":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":true,"right":"auto","top":"auto","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"},"legend":{"padding":5,"itemGap":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":14,"show":false,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"auto","itemWidth":25,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"series":{"aspectScale":0.75,"itemStyle":{"areaColor":"#a8d5fc"},"zoom":1.2,"label":{"emphasis":{"show":true,"textStyle":{"color":"#3ba372"}},"normal":{"color":"#3ba372","show":true}},"roam":true,"showLegendSymbol":false,"animation":false},"visualMap":{"min":0,"text":["High","Low"],"inRange":{"color":["#D2E9FF","#F0FFFF","#F5FFFA","#FFFACD","#B0E0E6","#80DEEA","#4682B4","#BCD4E6","#FFF5EE"]},"max":100,"calculable":true,"seriesIndex":[0]}},
			boardBase: {"funnelNum":6,"lineNum":8,"gaugeNum":8,"barNum":8,"pieNum":6},
			gauge: {"tooltip":{"formatter":"{b} : {c}","trigger":"item"},"backgroundColor":"transparent","color":["#5470c6","#91cc75","#fac858","#ee6666","#73c0de","#3ba272","#fc8452","#9a60b4","#ea7ccc"],"title":{"show":false,"textStyle":{"textBorderWidth":0,"color":"#ccc","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"top":"top","left":"left"},"series":{"pointer":{"offsetCenter":[0,"10%"],"icon":"path://M2.9,0.7L2.9,0.7c1.4,0,2.6,1.2,2.6,2.6v115c0,1.4-1.2,2.6-2.6,2.6l0,0c-1.4,0-2.6-1.2-2.6-2.6V3.3C0.3,1.9,1.4,0.7,2.9,0.7z","width":8,"length":"80%"},"axisLine":{"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"opacity":0.5,"shadowBlur":1,"shadowColor":"#000"},"roundCap":true},"anchor":{"show":true,"itemStyle":{"color":"inherit"},"size":18,"showAbove":true},"emphasis":{"disabled":false},"progress":{"show":true,"roundCap":true,"overlap":true},"splitNumber":25,"detail":{"formatter":"{value}","backgroundColor":"inherit","color":"#fff","borderRadius":3,"width":20,"fontSize":12,"height":12},"title":{"color":"#ccc","fontSize":12},"animation":true}},
			myChart0: null,
			boardDataList: [],
            systemIntroductionDetail: null,
			dates: '',
            zufangCount: 0,
			particlesJson: {"retina_detect":true,"particles":{"number":{"density":{"value_area":800,"enable":true},"value":120},"move":{"straight":false,"random":false,"bounce":false,"enable":true,"attract":{"rotateX":600,"enable":false,"rotateY":1200},"speed":3,"direction":"none","out_mode":"out"},"color":{"value":"#ffffff"},"shape":{"image":{"width":100,"src":"img/github.svg","height":100},"polygon":{"nb_sides":5},"type":"circle","stroke":{"color":"#000000","width":0}},"size":{"anim":{"size_min":0.1,"sync":false,"enable":false,"speed":20},"random":true,"value":1},"line_linked":{"width":1,"distance":40,"color":"#ffffff","opacity":1,"enable":true},"opacity":{"anim":{"opacity_min":0.1,"sync":false,"enable":false,"speed":1},"random":false,"value":1}},"interactivity":{"detect_on":"canvas","events":{"resize":true,"onclick":{"mode":"push","enable":true},"onhover":{"mode":"grab","enable":true}},"modes":{"grab":{"distance":120,"line_linked":{"opacity":1}},"bubble":{"duration":2,"distance":400,"size":40,"opacity":8,"speed":3},"repulse":{"duration":0.4,"distance":300},"push":{"particles_nb":4},"remove":{"particles_nb":2}}}}
		};
	},
  mounted(){
    this.init();
...
//统计接口1
    zufangChat1() {
      this.$nextTick(()=>{
        ...
        var zufangChart1 = echarts.init(document.getElementById("zufangChart1"),'macarons');
        this.$http({
            url: "zufang/group/price",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                zufangChart1.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, zufangChart1)
...
//统计接口2
    zufangChat2() {
      this.$nextTick(()=>{
        ...
        var zufangChart2 = echarts.init(document.getElementById("zufangChart2"),'macarons');
        this.$http({
            url: "zufang/group/areanum",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
...
//统计接口3
    zufangChat3() {
      this.$nextTick(()=>{
        ...
        var zufangChart3 = echarts.init(document.getElementById("zufangChart3"),'macarons');
        this.$http({
            url: "zufang/group/floor",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'zufangChart4');
...
//统计接口5
    zufangChat5() {
      this.$nextTick(()=>{
        ...
        var zufangChart5 = echarts.init(document.getElementById("zufangChart5"),'macarons');
        this.$http({
            url: "zufang/group/geju",
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
